...
var file_proto_system_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x22, 0x21, 0x0a, 0x0b,
	...
	,
	...
	0x65, 0x61, 0x6d, 0x12, 0x1b, 0x2e, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x2e, 0x53, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1c, 0x2e, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
	...
	0x12, 0x19, 0x2e, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x2e, 0x42, 0x69, 0x64, 0x69, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x73, 0x79,
	0x73, 0x74, 0x65, 0x6d, 0x2e, 0x42, 0x69, 0x64, 0x69, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x10, 0x5a,
	0x0e, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x62,
...
var file_proto_system_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_proto_system_proto_goTypes = []interface{}{
	(*CallRequest)(nil),          // 0: system.CallRequest
	(*CallResponse)(nil),         // 1: system.CallResponse
	(*ClientStreamRequest)(nil),  // 2: system.ClientStreamRequest
	(*ClientStreamResponse)(nil), // 3: system.ClientStreamResponse
	(*ServerStreamRequest)(nil),  // 4: system.ServerStreamRequest
	(*ServerStreamResponse)(nil), // 5: system.ServerStreamResponse
	(*BidiStreamRequest)(nil),    // 6: system.BidiStreamRequest
	(*BidiStreamResponse)(nil),   // 7: system.BidiStreamResponse
}
var file_proto_system_proto_depIdxs = []int32{
	0, // 0: system.System.Call:input_type -> system.CallRequest
	2, // 1: system.System.ClientStream:input_type -> system.ClientStreamRequest
	4, // 2: system.System.ServerStream:input_type -> system.ServerStreamRequest
	6, // 3: system.System.BidiStream:input_type -> system.BidiStreamRequest
	1, // 4: system.System.Call:output_type -> system.CallResponse
	3, // 5: system.System.ClientStream:output_type -> system.ClientStreamResponse
	5, // 6: system.System.ServerStream:output_type -> system.ServerStreamResponse
	7, // 7: system.System.BidiStream:output_type -> system.BidiStreamResponse
...
func file_proto_system_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_system_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_system_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_system_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_system_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_system_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {

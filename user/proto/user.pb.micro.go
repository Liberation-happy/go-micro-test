...
type AccountService interface {
	...
	// 修改权限
	UpdatePermission(ctx context.Context, in *UpdatePermissionRequest, opts ...client.CallOption) (*GetPermissionResponse, error)
	// 退出账号
...
func (c *accountService) UpdatePermission(ctx context.Context, in *UpdatePermissionRequest, opts ...client.CallOption) (*GetPermissionResponse, error) {
	req := c.c.NewRequest(c.name, "Account.UpdatePermission", in)
	out := new(GetPermissionResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type AccountHandler interface {
	...
	// 修改权限
	UpdatePermission(context.Context, *UpdatePermissionRequest, *GetPermissionResponse) error
	// 退出账号
...
func RegisterAccountHandler(s server.Server, hdlr AccountHandler, opts ...server.HandlerOption) error {
	type account interface {
		...
		UpdatePermission(ctx context.Context, in *UpdatePermissionRequest, out *GetPermissionResponse) error
...
func (h *accountHandler) UpdatePermission(ctx context.Context, in *UpdatePermissionRequest, out *GetPermissionResponse) error {
	return h.AccountHandler.UpdatePermission(ctx, in, out)
}
